...
impl Request1 {
  ...
  pub fn with_exchange(mut self, exchange: String) -> Request1 {
    self.exchange = Some(exchange);
    self
  }
  ...
  pub fn with_market(mut self, market: String) -> Request1 {
    self.market = Some(market);
    self
  }
  ...
  pub fn with_data_format(mut self, data_format: String) -> Request1 {
    self.data_format = Some(data_format);
    self
  }
  ...
  pub fn with_orient(mut self, orient: String) -> Request1 {
    self.orient = Some(orient);
    self
  }
  ...
  pub fn with_start_date(mut self, start_date: String) -> Request1 {
    self.start_date = Some(start_date);
    self
  }
  ...
  pub fn with_end_date(mut self, end_date: String) -> Request1 {
    self.end_date = Some(end_date);
    self
  }
